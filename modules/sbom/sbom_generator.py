...
class SBOMGenerator:
    ...
    def generate_batch(self, repos_metadata: List[Dict]) -> List[Dict]:
        results: List[Dict] = []
...
def main():
    ...
    generator = SBOMGenerator(output_dir=str(SBOMS_DIR), project_language=args.project_language)
    results = generator.generate_batch(cloned_repos)
